...
async function testGET() {
  console.log('\n=== Testing GET /api/on-chain-oracle ===\n');

  try {
    const url = `${BASE_URL}/api/on-chain-oracle?asset=BTC&context=On-chain metrics analysis`;
    console.log(`GET ${url}`);
...
async function testPOST() {
  console.log('\n=== Testing POST /api/on-chain-oracle ===\n');

  try {
    const url = `${BASE_URL}/api/on-chain-oracle`;
    const body = {
      asset: 'ETH',
      context: 'Analyze TVL, active addresses, and transaction volume metrics'
    };
...
async function testErrors() {
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/api/on-chain-oracle`);
    const data = await response.json();
...
async function runTests() {
  console.log('🔗 GLM On-Chain Oracle API Tests');
  console.log('=================================\n');
  console.log('Testing API endpoint: /api/on-chain-oracle\n');
